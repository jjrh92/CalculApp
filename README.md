...
![Github Contributors](https://img.shields.io/github/contributors/jjrh92/CalculApp)
![Github Stars](https://img.shields.io/github/stars/jjrh92/CalculApp)
![Github Issues](https://img.shields.io/github/issues-raw/jjrh92/CalculApp)
...
<h3 align="center">Welcome - Bienvenid@</h3>
  ...
  <p align=center">
    ...
    ·
    <a href="https://github.com/jjrh92/CalculApp/issues">Report Bug - Reportar Bug</a>
    ·
    <a href="https://github.com/jjrh92/CalculApp/issues">Request Feature - Pedir Feature</a>
  </p>
</div>
...
Clone the repo and run the command npm install, then run the command npm run dev
   ```sh
   git clone https://github.com/jjrh92/CalculApp.git
   ```
